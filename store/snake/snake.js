    ...
    */
    function getClientWidth(){
        ...
        if( typeof window.innerWidth === "number" ) {
            myWidth = (94 / 100) * window.innerWidth;//Non-IE
        } else if( document.documentElement && ( document.documentElement.clientWidth || document.documentElement.clientHeight ) ) {
            myWidth = (94 / 100) * document.documentElement.clientWidth;//IE 6+ in 'standards compliant mode'
        } else if( document.body && ( document.body.clientWidth || document.body.clientHeight ) ) {
            myWidth = (94 / 100) * document.body.clientWidth;//IE 4 compatible
        }
        return myWidth;
    }
    /*
    ...
    */
    ...
    return function(inputConfig) {
        ...
        function createBoardElements() {
            ...
            elmPauseScreen.innerHTML = "<div style='padding:15px;'>Game Paused<p/>Press [space] to unpause.</div>";
        ...
        function createWelcomeElement() {
            ...
            welcomeTxt.innerHTML = "<p>Use the <b>arrow keys</b> on your keyboard to play the game.</p> " + fullScreenText + "<p></p>";
            var welcomeStart = document.createElement("button");
            welcomeStart.style.padding = "5px 20px"
            welcomeStart.style.margin = "20px 5px"
            welcomeStart.style.border = "2px solid gray"
            welcomeStart.style.borderRadius = "2px"
        ...
        function createGameEndElement(message, elmId, elmClassName) {
            ...
            gameEndTxt.innerHTML = "<p>" + message + "</p>";
            var gameEndStart = document.createElement("button");
            gameEndStart.style.padding = "5px 20px"
            gameEndStart.style.margin = "20px 5px"
            gameEndStart.style.border = "2px solid gray"
            gameEndStart.style.borderRadius = "2px"
